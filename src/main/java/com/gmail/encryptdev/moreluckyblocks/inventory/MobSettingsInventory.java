...
public class MobSettingsInventory extends AbstractInventory {
    ...
    public MobSettingsInventory() {
        ...
        bukkitInventory.setItem(21, ItemCreator.getItem(Material.DIAMOND_HOE, "§eMain Hand",
        ...
        bukkitInventory.setItem(38, ItemCreator.getItem(Material.POTION, "§eRegeneration", Arrays.asList("§eStatus: §4OFF")));
        bukkitInventory.setItem(39, ItemCreator.getItem(Material.POTION, "§eInvisibility", Arrays.asList("§eStatus: §4OFF")));
        bukkitInventory.setItem(40, ItemCreator.getItem(Material.POTION, "§eStrength", Arrays.asList("§eStatus: §4OFF")));
        bukkitInventory.setItem(41, ItemCreator.getItem(Material.POTION, "§eSpeed", Arrays.asList("§eStatus: §4OFF")));
